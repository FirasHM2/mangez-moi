(function ($) {
	...
	if (firstNextBtn && firstNextBtn.addEventListener("click", function () {
	...
	if (nextBtnSec && nextBtnSec.addEventListener("click", function () {
	...
	if (nextBtnThird && nextBtnThird.addEventListener("click", function () {
	...
	if (prevBtnSec && prevBtnSec.addEventListener("click", function () {
	...
	if (prevBtnThird && prevBtnThird.addEventListener("click", function () {
		slidePage.style.marginLeft = "-25%";
		bullet[current - 2].classList.remove("active");
		progressCheck[current - 2].classList.remove("active");
		progressText[current - 2].classList.remove("active");
	...
	if (prevBtnFourth && prevBtnFourth.addEventListener("click", function () {
		slidePage.style.marginLeft = "-50%";
		bullet[current - 2].classList.remove("active");
		progressCheck[current - 2].classList.remove("active");
		progressText[current - 2].classList.remove("active");
